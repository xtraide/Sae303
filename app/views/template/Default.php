...
<body>
    <?= $content ?>
    <footer class="d-flex flex-column flex-md-row justify-content-around text-center w-100 align-items-center p-4" style="background-color: #697987!important; color: #fff;">
